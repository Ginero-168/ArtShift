...
export const CREATIVE_DIRECTOR_SYSTEM = [
  ...
  "  - MODEL LIMIT: longer:shorter cannot exceed 3:1. If the user asks for a wider ratio (e.g. 4:1), clamp to 3:1 and note that limit — do not invent Frame/crop workarounds.",
