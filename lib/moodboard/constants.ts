 ...
 * `openai/gpt-image-2.5-flare` at `quality: "low"` (~$0.012 / image).
 * A 9-pack is ~$0.11 (9 × $0.012 = $0.108). 16 ≈ $0.19. 25 ≈ $0.30.
...
/** Exact estimate in USD, rounded to the nearest tenth of a cent (9 → 0.108). */
...
/** Default 9-pack estimate ($0.108). User-facing copy may round this to ~$0.11. */
