/* @ts-self-types="./vtracer_browser.d.ts" */
 ...
 * @returns {string}
 */
export function vectorize_rgba(pixels, width, height, options) {
    let deferred3_0;
    let deferred3_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vtracer_browser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
